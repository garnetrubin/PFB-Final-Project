...
<div class="landing-grid">
    ...
    <div class="landing-info">
        <!-- We added width="300" here. It forces the image to be 300 pixels wide. -->
<img src="asset/HealthTrack.png" alt="HealthTrack Logo" class="app-logo" width="300">
    ...
    <div class="login-box">
        <div class="card">
            <!-- Optional: You can also put the small logo here if you want -->
            <!-- <img src="HealthTrack.jpg" class="app-logo-small"> -->
